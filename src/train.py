...
def run_training(params):
    ...
    valid_loader = pre.load_data(DATA_PATH, sb_n, [1], [1, 2], VALID_TRIAL_LIST, tcn_used=TCN_USED, batch_size=params['batch_size'], shuffle=True, drop_last=True, num_workers=N_WORKERS, pin_memory=True)
